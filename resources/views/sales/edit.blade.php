                    ...
                    <form class="forms-sample create-user pt-2">
                            ...
                            @foreach ($product1 as $pr1)
                                <div class="row productdata" id="">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select class="form-control sku-select productselect" name="sku" required disabled>
                                    ...
                                    <div class="form-group asd col-sm-6">
                                        ...
                                        <select class="form-control sub-sku productselect" name="sub_sku" disabled>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" value="{{ $pr1['price'] }}" class="form-control tprice"
                                            name="price" placeholder="Enter Price" required disabled>
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="exampleInputPassword1">Qty. :</label>
                                        <div class="row">
                                            <div class="col-sm-12"><input type="number" data-old_qty="<?php $var = $pr1['qty'];
                                            echo abs($var); ?>"
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" value="{{ $data['total_price'] }}" class="form-control total_price"
                                    data-total_price="{{ $data['total_price'] }}" name="total_price"
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select class="form-control payment_status" name="payment_status" required>
                                    ...
                                    <option value="1" <?php echo $data['payment_status'] == 1 ? 'selected' : ''; ?>>Clear</option>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control total_payment"
                                    value="{{ $data['total_payment'] }}" name="total_payment" placeholder="Total Payment"
                                    required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="exampleInputPassword1">Due Payment :</label>
                                <input type="text" class="form-control due_payment"
                                    value="{{ $data['due_payment'] }}" name="due_payment" placeholder="Due Payment"
                                    required disabled>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            //     } else {
            //         let price = qtyTag.parent().parent().parent().siblings().children(".tprice").data(
            //             'total_price');
            ...
            $(document).on('change', ".sub-sku", function() {
                ...
                if(!val) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data) {
                                selectTag.parent().siblings().children(".product-name").val(data.name);
                                selectTag.parent().siblings().children(".tprice").val(data.t_price);
                            }
                            // d.closest('.productdata').find('.tprice').val(data);
                        },
                        error: function(xhr, status, error) {
            ...
            $('.addData').click(function() {
                ...
                let str =
                    '<hr class="bg-secondary hr-line mt-3 mb-4"> <div class="row productdata"> <div class="form-group col-sm-6"> <label for="exampleInputPassword1">Choose SKU :</label>\n\
                                          ...
                                          <div class="row"><div class="col-sm-10"><input type="number" class="form-control qty" name="qty" placeholder="Enter Quantity" onkeyup="calculatePrice()"></div><div class="col-sm-2"><a class="btn btn-sm btn-light" onClick="remove_section(this)"><i class="fa fa-close"></i></a></div></div></div></div>';
